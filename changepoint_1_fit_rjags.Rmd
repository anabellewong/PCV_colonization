...
source('_functions/hierarchical_log_ethnicitym5.R')
mod5 <- hierarchical_model_log(log_gmc_mean= mean(a1$log_GMC),
                               log_gmc_prec= 1/(var(a1$log_GMC)*2))
saveRDS(mod5, "_models/mod5.RDS")


# mod5 with flat prior for cp (run time: 2 hrs on PC)
source('_functions/hierarchical_log_ethnicitym6.R')
mod6 <- hierarchical_model_log(log_gmc_mean= mean(a1$log_GMC),
                               log_gmc_prec= 1/(var(a1$log_GMC)*2))
