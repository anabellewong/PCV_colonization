################################################################################
# This script contains functions for fitting a change point model with the rjags 
# package. There are two model variants:
#
# hierarchical_model_log_m5; and
# hierarchical_model_log_m6.
################################################################################

# m5: serotype-specific intercepts, change points, and slopes, with ethnic(Bedouin)-
# specific intercept (Ref ethnic group: Jewish)
hierarchical_model_log_m5 <-function(log_gmc_mean, log_gmc_prec){
  model_string<-"
model{
...
# m6: same as m5 but with flat priors for change point
